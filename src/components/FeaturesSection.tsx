          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex flex-col h-full">
                {/* Icon */}
                <div className={`w-14 h-14 rounded-xl bg-${feature.color}/10 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}>
