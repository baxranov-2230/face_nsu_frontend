    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card/80 backdrop-blur border border-border/50 shadow-soft mb-8 animate-fade-up">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            Face ID bilan
            <br />
            <span className="text-gradient">Test yechish</span>
            <br />
            platformasi
          </h1>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: "0.2s" }}>
            Yuz identifikatsiyasi orqali xavfsiz autentifikatsiya. Nazorat vositalari, multimodal testlar va amaliy loyihalar bir joyda.
          </p>
